...
import { calculateHalfedRange, getQuerysFromString } from '../modules/calculats.js';
...
const fillItem = async (itemData, element) => {
    ...
    if (typeof itemData.posters == 'object') {
        let posterURL = '../images/example.png';
    ...
    element.getElementsByTagName('a')[0].href = '../pages/player.html?id=' + itemData.id;
};
